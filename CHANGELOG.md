...
* feat(api): support quarantined inbound message processing by @bjarn in https://github.com/lettermint/lettermint-go/pull/25

**Full Changelog**: https://github.com/lettermint/lettermint-go/compare/v2.4.1...v2.5.0

## v2.4.1 - 2026-08-29

### What's Changed

* fix: add /v2 suffix to Go module path so v2 tags resolve by @bjarn in https://github.com/lettermint/lettermint-go/pull/24

**Full Changelog**: https://github.com/lettermint/lettermint-go/compare/v2.4.0...v2.4.1

## v2.4.0 - 2026-08-27

### What's Changed

* feat(api): support scheduled message delivery by @bjarn in https://github.com/lettermint/lettermint-go/pull/22

**Full Changelog**: https://github.com/lettermint/lettermint-go/compare/v2.3.0...v2.4.0

## v2.3.0 - 2026-08-19

### What's Changed

* feat(api): support message tags and disposable email suppression by @bjarn in https://github.com/lettermint/lettermint-go/pull/21

**Full Changelog**: https://github.com/lettermint/lettermint-go/compare/v2.2.0...v2.3.0

## v2.2.0 - 2026-08-13

### What's Changed

* ci: bump actions/setup-go from 6 to 7 by @dependabot[bot] in https://github.com/lettermint/lettermint-go/pull/19
* feat(api): add team RBAC and complete email delivery options by @bjarn in https://github.com/lettermint/lettermint-go/pull/20

**Full Changelog**: https://github.com/lettermint/lettermint-go/compare/v2.1.0...v2.2.0
